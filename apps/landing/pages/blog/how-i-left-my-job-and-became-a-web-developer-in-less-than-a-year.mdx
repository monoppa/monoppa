...
export const meta = {
  ...
  description:
    "We don't celebrate what we've got and we criticise what we don't have. You are capable.",
  views: 2214,
  tags: ['tech'],
}

![Software engineer working in a cafe](/img/blog/how-i-left-my-job-and-became-a-web-developer-in-less-than-a-year/software-engr-cafe.png 'Software engineer working in a cafe')
...
![Melting Rubiks Cube](/img/blog/how-i-left-my-job-and-became-a-web-developer-in-less-than-a-year/rubiks-cube.png 'Melting Rubiks Cube')
...
![Courses on Udemy](/img/blog/how-i-left-my-job-and-became-a-web-developer-in-less-than-a-year/udemy-code.png 'Courses on Udemy')
...
![A man looking for a job](/img/blog/how-i-left-my-job-and-became-a-web-developer-in-less-than-a-year/job-hunting.png 'A man looking for a job')
