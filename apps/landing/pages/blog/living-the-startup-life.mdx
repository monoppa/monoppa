...
export const meta = {
  ...
  description:
    'Working at a startup has always been intriguing for me. Intense, fulfilling and fun!',
  views: 424,
  tags: ['startup', 'tech'],
}

![Rocket Living the startup life](/img/blog/living-the-startup-life/cover-1.png 'Rocket Living the startup life')
...
![Man tensed in front of train](/img/blog/living-the-startup-life/man-intense-train.jpg 'Man tensed in front of train')
...
![man successfully hiking with sunrise](/img/blog/living-the-startup-life/mon_man_successfully_hiking_with_sunrise.png 'man successfully hiking with sunrise')
...
![Pineapples with shades](/img/blog/living-the-startup-life/pineapple-party.jpg 'Pineapples with shades')
